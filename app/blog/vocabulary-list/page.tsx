      ...
      <main className="max-w-3xl mx-auto px-4 py-10">
        <article className="bg-white p-8 rounded-2xl shadow-sm border border-gray-100">
          ...
          <div className="prose prose-blue max-w-none">
            ...
            <h2 className="text-xl font-bold border-l-4 border-blue-600 pl-3 mb-4 mt-8">1. 文末の「〜と思います」徹底攻略</h2>
            <p className="mb-4 text-sm text-gray-600">
              レポートにおいて「思います」は、個人の感想（主観）と捉えられるため、原則として使いません。根拠の強さに応じて、以下の言葉に変換しましょう。
            </p>

            <h3 className="text-lg font-bold mt-6 mb-3">根拠がある場合（推測・考察）</h3>
            ...
            <h3 className="text-lg font-bold mt-6 mb-3">断定できる場合</h3>
            <ul className="list-disc ml-5 text-sm mb-4 text-gray-600 space-y-2">
              <li><strong>〜といえる / 〜と言えよう</strong><br/>強い根拠があり、結論づける時に使います。</li>
              <li><strong>〜である / 〜だ</strong><br/>事実を述べる時はシンプルに言い切ります。</li>
            </ul>

            <h2 className="text-xl font-bold border-l-4 border-blue-600 pl-3 mb-4 mt-8">2. 「話し言葉」を「書き言葉」に変換リスト</h2>
            <p className="mb-4 text-sm text-gray-600">
              無意識に使っているその言葉、実はレポートではNGかもしれません。以下の一覧表でチェックしてみましょう。
            </p>

            <div className="overflow-x-auto">
              <table className="w-full text-sm text-left text-gray-600 border rounded-lg mb-6">
            ...
            <h2 className="text-xl font-bold border-l-4 border-blue-600 pl-3 mb-4 mt-8">3. 文章を格上げする「接続詞」の使い分け</h2>
            <p className="mb-4 text-sm text-gray-600">
              文と文をつなぐ接続詞が適切だと、論理構成がしっかりしている印象を与えます。「また」「そして」ばかり使わず、バリエーションを持たせましょう。
            </p>

            <h3 className="text-lg font-bold mt-4 mb-2">逆接（前の内容と対立させる）</h3>
            ...
            <h3 className="text-lg font-bold mt-4 mb-2">因果関係（理由と結果をつなぐ）</h3>
            <ul className="list-disc ml-5 text-sm mb-4 text-gray-600">
            ...
            <h2 className="text-xl font-bold border-l-4 border-blue-600 pl-3 mb-4 mt-8">4. おすすめの参考書籍</h2>
            <p className="mb-4 text-sm text-gray-600">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 my-6">
              <div className="border rounded-xl p-4 flex flex-col items-center text-center shadow-sm">
                <h4 className="font-bold text-sm mb-2">日本語の作文技術</h4>
                <img src="https://shop.r10s.jp/book/cabinet/0943/9784062130943.jpg" alt="日本語の作文技術" className="w-24 mb-3 shadow-md" />
              ...
              <div className="border rounded-xl p-4 flex flex-col items-center text-center shadow-sm">
                <h4 className="font-bold text-sm mb-2">文章力の基本</h4>
                <img src="https://m.media-amazon.com/images/I/51Z7YyM7b+L._SY466_.jpg" alt="文章力の基本" className="w-24 mb-3 shadow-md" />
                <p className="text-[10px] text-gray-500 mb-2">短期間で劇的に文章が直る、即効性のある一冊。</p>
                <div className="flex gap-2 w-full mt-auto">
                    <a href="https://www.amazon.co.jp/dp/453404593X?tag=acky0113-22" target="_blank" rel="noopener noreferrer" className="flex-1 bg-[#FF9900] text-white text-xs font-bold py-2 rounded hover:opacity-80">Amazon</a>
                    <a href="https://a.r10.to/hPUG4a" target="_blank" rel="noopener noreferrer" className="flex-1 bg-[#BF0000] text-white text-xs font-bold py-2 rounded hover:opacity-80">楽天</a>
                </div>
              </div>
            </div>
