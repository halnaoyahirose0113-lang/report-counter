          ...
          <div className="prose prose-blue max-w-none">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 my-6">
              <div className="border rounded-xl p-4 flex flex-col items-center text-center shadow-sm">
                ...
                <img src="https://images-na.ssl-images-amazon.com/images/P/4140912723.09.LZZZZZZZ.jpg" alt="論文の教室" className="w-24 mb-3 shadow-md" />
              ...
              <div className="border rounded-xl p-4 flex flex-col items-center text-center shadow-sm">
                ...
                <img src="https://images-na.ssl-images-amazon.com/images/P/B077RWQNKN.09.LZZZZZZZ.jpg" alt="コピペと言われないレポートの書き方" className="w-24 mb-3 shadow-md" />
                <div className="flex gap-2 w-full mt-auto">
